class CustomerPage {
  ...
  constructor() {
	...
	// I have a relatively decent understanding of the code in this project, likely will need to check out some
	// Specific syntax, but that's not too bad.
	// This needs to be updated to whatever port my computer happens to use.
    // instance variables that the app needs but are not part of the "state" of the application
    this.server = "https://localhost:7213/api"
